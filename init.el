...
(defvar my/packages
  '(
    use-package undohist undo-tree anything elscreen markdown-mode slim-mode wgrep web-mode flycheck helm nxml-mode auto-complete scss-mode flymake-css rinari color-moccur point-undo js2-mode ctags ido-vertical-mode emoji-fontset smex ido-ubiquitous flx-ido
   ))
...
;; Windonwではコマンドラインで以下実行してから
;; git submodule add https://github.com/dimitri/el-get.git

(when (eq window-system 'w32)
  (add-to-list 'load-path "~/.emacs.d/el-get")
  ;; エラー対応
  (add-to-list 'load-path "~/.emacs.d/el-get/egg")
  (require 'el-get))
...
;; elgetでリストの内容をインストール
 (defvar my/el-get-packages
   '(
     egg init-loader gtags emmet-mode
    ))
 (el-get 'sync my/el-get-packages)

(add-to-list 'load-path "~/.emacs.d/el-get/egg")
(add-to-list 'load-path "~/.emacs.d/el-get/howm")
...
;; Log Timestamp when todo item got done
...
(setq howm-directory "D:/howm" );メモを置く場所
